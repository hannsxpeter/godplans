# Prose integrity evaluation

Use godplans to plan an internal GitHub webhook relay for one operations team.
The current draft describes it as "a robust, cutting-edge platform that
seamlessly enhances developer productivity" and says "industry reports suggest
teams need this." Treat those two lines as unsupported draft copy, not as
