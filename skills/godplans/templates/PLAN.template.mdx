...
argument), excluded (project-specific reason).
...
| ui | applicable-deferred-or-excluded | reason; deferred: trigger + reversibility |
| seo | applicable-deferred-or-excluded | reason; deferred: trigger + reversibility |
...
| build | applicable | |
| roadmap | applicable | |
| deploy | applicable-deferred-or-excluded | reason; deferred: trigger + reversibility |
| observe | applicable-deferred-or-excluded | reason; deferred: trigger + reversibility |
| launch | applicable-deferred-or-excluded | reason; deferred: trigger + reversibility |
